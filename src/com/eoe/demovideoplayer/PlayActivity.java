...
public class PlayActivity extends Activity implements OnClickListener,
	...
	private void getInitDate() {
		...
		//path = "ed2k://|file|[ÒÃºÍÔ°].Summer.Palace.2006.D9.MiniSD-TLF.mkv|985365230|421B4EE6C645B2C5DA2DFE02806471D9|h=SKD5LPQYOMTLXKNEXQFYLC5HSVP4AEUE|/";
		name = getIntent().getStringExtra("name");
		//urls=getIntent().getStringArrayListExtra("url");

	}
	private void setInitDate() {
		nametTextView.setText("ÊÓÆµÃû×Ö£º"
				+ name);
	}
